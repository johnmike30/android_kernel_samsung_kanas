...
static __init void __irq_init(void)
{
	...
	__raw_writel(~0, (void __iomem *)(SPRD_INTC0_BASE + INTC_IRQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC0_BASE + INTC_FIQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC1_BASE + INTC_IRQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC1_BASE + INTC_FIQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC2_BASE + INTC_IRQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC2_BASE + INTC_FIQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC3_BASE + INTC_IRQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INTC3_BASE + INTC_FIQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INT_BASE + INTC_IRQ_DIS));
	__raw_writel(~0, (void __iomem *)(SPRD_INT_BASE + INTC_FIQ_DIS));
}
...
static inline void __mux_irq(u32 irq, u32 offset, u32 is_unmask)
{
	...
	if (!__irq_mux_irq_find(irq, &base, &bit, &index)) {
		...
		if (is_unmask) {/*if any one need unmask(wakeup source), let the irq mux bit enable*/
			__raw_writel(1 << bit, (void __iomem *)(base + offset));
		} else {/*maybe mask*/
			s = ARRAY_SIZE(_mux);
			while (s--) {
				if (_mux[s].is_unmask) {
...
void __init sci_init_irq(void)
{
	...
	__raw_writel(1<<LEGACY_FIQ_BIT, (void __iomem *)(CORE_GIC_DIS_VA + GIC_DIST_ENABLE_CLEAR));
#endif
	__raw_writel(1<<LEGACY_IRQ_BIT, (void __iomem *)(CORE_GIC_DIS_VA + GIC_DIST_ENABLE_CLEAR));
